...
function ParagraphChange({ dispatch }: { dispatch: Dispatch }): JSX.Element {
    return (
        <div role="button" onClick={() => dispatch({ type: 'changeQuestion' })}>
            <svg
...
export default ParagraphChange
